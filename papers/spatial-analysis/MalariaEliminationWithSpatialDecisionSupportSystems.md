...
1University of Queensland, School of Population Health, Brisbane, Australia
2Swiss Tropical and Public Health Institute, Basel, Switzerland
3University of Basel, Basel, Switzerland
4University of New South Wales, The Kirby Institute for Infection and Immunity in Society, Sydney, Australia
Operational challenges facing contemporary malaria
...
prerequisite [9]. This often presents significant
to
challenges
existing national health information systems (HISs) in
...
visualise and identify trends and patterns in the
Review
Corresponding
spatial
author: Kelly, G.C. (gerardckelly@gmail.com).
...
as indoor residual spraying (IRS) and mosquito
distribution.
net
GR involves data collection, mapping and
...
SDSS based on household GR data to support
Review
Trends
scaled-up
...
based decision making to support management issues
a
with
spatial or geographical focus. Figure 2 illustrates a
...
tional priorities of these individual phases but also have
Key:
Household - with LLIN
Household - without LLIN
Unpopulated household
Settlement name
Health facility
Road / track
Watercourse
...
focal IRS, and positive case surveillance at a household level as part of the progressive Solomon Islands Malaria Elimination
Review
Trends
Programme.
in Parasitology July 2012, Vol. 28, No. 7
...
incidence, as well as the overall preparedness of
programmes
malaria
to implement elimination, can be developed
within a GIS-based SDSS to visualise (at differing admin-
istrative and geographical scales) and delineate target
areas, and to measure and assess progress made
Malaria elimination spatial decision support system conceptual framework
Routinely reported data Field surveys / data collection
e.g. Passive case data; e.g. Geographical reconnaissance (GR);
health information system (HIS) reports; larval surveys;
routine vector control activities malaria indicator surveys (MIS)
Inputs Data / results re-entered into SDSS to provide
continuous operational support
Baseline spatial / GIS data
e.g. Topographic data layers
Vector control and malaria prevention
(coastline, rivers, terrain, etc.); Expert knowledge interventions
demographic / infrastructure data e.g. Malaria / vector control staff; e.g. Targeted / Focal IRS;
(settlements, roads, buildings, etc.) health facility workers; blanket LLIN Distribution;
Spatial decision community volunteers entomological surveillance;
community awareness
Support system
Case management, surveillance-
response
Informed decision / e.g. Strategic active case detection;
strategic action outbreak detection and response;
(to support operational case investigation and follow-up;
priorities) drug resistance monitoring
Outputs
Monitoring and evaluation
e.g. Assessment and mapping of malaria
Tabular reports Statistical / spatial analysis intervention coverage and service delivery;
e.g. Routine Health Facility reports, e.g. Geo-statistical analysis, modelling, malaria risk stratification;
Automated summary reports (e.g. vector prediction and mapping of malaria inci- automated reporting and data analysis;
...
progress, identify problems at the level of an individual
operator,
spray
and implement remedial action when required to assure
...
control of vector-borne diseases in resource-poor environments
Review
Trends
[63].
in Parasitology July 2012, Vol. 28, No. 7
...
into an elimination-focused health system could provide
powerful
a
visual mechanism to monitor the distribution of
...
and aim to incorporate and build upon existing
Box
systems
2. Supporting Pacific island malaria elimination with spatial decision support systems
...
entomological surveillance and focal IRS [58]. Figure 3 provides
example
an
screenshot of the Isabel Province SDSS graphical user
...
such as voice-over-Internet Protocol (VoIP) services
collaborative
and
websites (e.g. internet forums and wikis),
...
Acknowledgements
The support of the Solomon Islands and Vanuatu National Malaria
Programmes are acknowledged for their cooperation and sharing of
information. Specifically, we thank the National Vector-borne Diseases
Control Programme (NVBDCP) Directors Albino Bobogare (Solomon
Islands) and George Taleo and Surveillance, Monitoring and Evaluation
Officers Erick Hale, William Batarii, Andrew Newa and Watson Hevalao
(Solomon Islands), and Wesley Donald and Johnny Nausien (Vanuatu).
We also thank the ongoing support of the Pacific Malaria Initiative
Support Centre (PacMISC), School of Population Health, University of
...
3 Mendis, K. et al. (2009) From malaria control to eradication: the WHO
perspective. Trop. Med. Int. Health 14, 802–809
4 Feachem, R.G.A. et al., eds (2009) Shrinking the Malaria Map: A
Prospectus on Malaria Elimination, The Global Health Group,
Global Health Sciences
5 GMAP (2008) The Global Malaria Action Plan, Roll Back Malaria
Partnership
6 The malERA Consultative Group on Health Systems Operational
Research (2011) A research agenda for malaria eradication: health
systems and operational research. PLoS Med. 8, e1000397
7 Das, P. and Horton, R. (2010) Malaria elimination: worthy, challenging,
and just possible. Lancet 376, 1515–1517
8 Hay, S.I. et al. (2008) Measuring malaria endemicity from intense to
interrupted transmission. Lancet Infect. Dis. 8, 369–378
9 Marsh, K. (2010) Research priorities for malaria elimination. Lancet
376, 1626–1627
10 Kerouedan, D. (2010) The global fund to fight HIV/AIDS, TB and
malaria 5-y: evaluation policy issues. Bull. Soc. Pathol. Exot. 103,
119–122
11 Vitoria, M. et al. (2009) The global fight against HIV/AIDS,
tuberculosis, and malaria: current status and future perspectives.
Am. J. Clin. Pathol. 131, 844–848
12 Bousema, T. et al. (2012) Hitting hotspots: spatial targeting of malaria
for control and elimination. PLoS Med. 9, e1001165
13 Greenwood, B.M. (1989) The microepidemiology of malaria and its
importance to malaria control. Trans. R. Soc. Trop. Med. Hyg. 83
(Suppl.), 25–29
14 Moonen, B. et al. (2010) Operational strategies to achieve and maintain
malaria elimination. Lancet 376, 1592–1603
15 Snow, J. (1855) On the Mode of Communication of Cholera, John
Churchill
16 Sipe, N.G. and Dale, P. (2003) Challenges in using geographic
information systems (GIS) to understand and control malaria in
Indonesia. Malar. J. 2, 36
17 Le Sueur, D. et al. (1997) An atlas of malaria in Africa. Afr. Health 19,
23–24
18 Hay, S. et al. (2002) Climate change and the resurgence of malaria in
the East African highlands. Nature 415, 905–909
19 Craig, M.H. et al. (2004) Exploring 30 years of malaria case data in
KwaZulu-Natal, South Africa: part I. The impact of climatic factors.
Trop. Med. Int. Health 9, 1247–1257
20 Craig, M.H. et al. (1999) A climate-based distribution model of malaria
transmission in sub-Saharan Africa. Parasitol. Today 15, 105–111
21 Hay, S.I. et al. (1998) Predicting malaria seasons in Kenya using
multitemporal meteorological satellite sensor data. Trans. R. Soc.
Trop. Med. Hyg. 92, 12–20
22 Parham, P.E. and Michael, E. (2010) Modelling climate change and
malaria transmission. Adv. Exp. Med. Biol. 673, 184–199
23 Parham, P.E. and Michael, E. (2010) Modeling the effects of weather
and climate change on malaria transmission. Environ. Health Perspect.
118, 620–626
24 Martens, P. and Hall, L. (2000) Malaria on the move: human
population movement and malaria transmission. Emerg. Infect. Dis.
6, 103–109
25 Foley, D.H. et al. (2002) Stream-bank shade and larval distribution of
the Philippine malaria vector Anopheles flavirostris. Med. Vet.
Entomol. 16, 347–355
26 Kitron, U. et al. (1994) Geographic information system in malaria
surveillance: mosquito breeding and imported cases in Israel, 1992.
Am. J. Trop. Med. Hyg. 50, 550–556
27 Saxena, R. et al. (2009) Application of spatial technology in malaria
research & control: some new insights. Indian J. Med. Res. 130,
125–132
28 Bogh, C. et al. (2007) High spatial resolution mapping of malaria
transmission risk in the Gambia, West Africa, using LANDSAT TM
satellite imagery. Am. J. Trop. Med. Hyg. 76, 875–881
29 Diuk-Wasser, M.A. et al. (2006) Patterns of irrigated rice growth and
malaria vector breeding in Mali using multi-temporal ERS-2 synthetic
aperture radar. Int. J. Remote Sens. 27,
Review
Trends
535–548
in Parasitology July 2012, Vol. 28, No. 7
...
31 Tran, A. et al. (2008) Using remote sensing to map larval and adult
populations of Anopheles hyrcanus (Diptera: Culicidae) a potential
malaria vector in Southern France. Int. J. Health Geogr. 7, 9
32 Kleinschmidt, I. et al. (2001) An empirical malaria distribution map for
West Africa. Trop. Med. Int. Health 6, 779–786
33 Hay, S.I. et al. (2009) A world malaria map: Plasmodium falciparum
endemicity in 2007. PLoS Med. 6, 286–302
34 Guerra, C.A. et al. (2008) The limits and intensity of Plasmodium
falciparum transmission: implications for malaria control and
elimination worldwide. PLoS Med. 5, e38
35 Gosoniu, L. et al. (2009) Mapping malaria risk in West Africa using a
Bayesian nonparametric non-stationary model. Comput. Stat. Data
Anal. 53, 3358–3371
36 Gemperli, A. et al. (2006) Mapping malaria transmission in West and
Central Africa. Trop. Med. Int. Health 11, 1032–1046
37 Brooker, S. et al. (2006) Spatial epidemiology of Plasmodium vivax,
Afghanistan. Emerg. Infect. Dis. 12, 1600–1602
38 Gemperli, A. et al. (2006) Malaria mapping using transmission models:
application to survey data from Mali. Am. J. Epidemiol. 163, 289–297
39 Kleinschmidt, I. et al. (2000) A spatial statistical approach to malaria
mapping. Int. J. Epidemiol. 29, 355–361
40 Kleinschmidt, I. et al. (2002) Rise in malaria incidence rates in South
Africa: a small-area spatial analysis of variation in time trends. Am. J.
Epidemiol. 155, 257–264
41 Kleinschmidt, I. et al. (2001) Use of generalized linear mixed models in
the spatial analysis of small-area malaria incidence rates in Kwazulu
Natal, South Africa. Am. J. Epidemiol. 153, 1213–1221
42 Noor, A.M. et al. (2008) Spatial prediction of Plasmodium falciparum
prevalence in Somalia. Malar. J. 7, 159
43 Reid, H. et al. (2010) Baseline spatial distribution of malaria prior to an
elimination programme in Vanuatu. Malar. J. 9, 150
44 Asiimwe, C. et al. (2011) Use of an innovative, affordable, and open-
source short message service-based tool to monitor malaria in remote
areas of Uganda. Am. J. Trop. Med. Hyg. 85, 26–33
45 Barrington, J. et al. (2010) SMS for life: a pilot project to improve anti-
malarial drug supply management in rural Tanzania using standard
technology. Malar. J. 9, 298
46 The malEra Consultative Group on Monitoring Evaluation and
Surveillance (2011) A research agenda for malaria eradication:
monitoring, evaluation, and surveillance. PLoS Med. 8, e1000400
47 Maheswaran, R. and Massimo, C. (2004) GIS in Public Health, CRC
Press
48 WHO (1965) Geographical Reconnaissance For Malaria Eradication
Programmes, World Health Organization
49 Najera, J.A. et al. (1998) Malaria Epidemics, Detection and Control,
Forecasting and Prevention, World Health Organization
50 Guintran, J.O. et al. (2006) Systems for the Early Detection of Malaria
Epidemic in Africa. An Analysis of Current Practices and Future
Priorities, World Health Organization
51 Huang, T.S. and Hairoi, M.J. (1980) Field Manual for Geographical
Reconnaissance and Spraying Operations, Malaria Control
...
54 Fletcher, L.A. et al. (2003) Handheld computers. A feasible alternative
to paper forms for field data collection. Eval. Rev. 27, 165–178
55 Vanden Eng, J.L. et al. (2007) Use of handheld computers with global
positioning systems for probability sampling and data entry in
household surveys. Am. J. Trop. Med. Hyg. 77, 393–399
56 Yu, P. et al. (2009) The development and evaluation of a PDA-based
method for public health surveillance data collection in developing
countries. Int. J. Med. Inform. 78, 532–542
57 Kelly, G.C. et al. (2010) Modern geographical reconnaissance of target
populations in malaria elimination zones. Malar. J. 9, 289
58 Kelly, G.C. et al. (2011) A spatial decision support system for guiding
focal indoor residual spraying interventions in a malaria elimination
zone. Geospat. Health 6, 21–31
59 Keenen, P.B. (2003) Spatial decision support systems. In Decision
Making Support Systems Achievements and Challenges for the New
Decade (Morah, M. et al., eds), pp. 28–39, Idea Group Publishing
60 Densham, D.J. (1991) Spatial decision support systems. In
Geographical Information Systems: Principle (Vol. 1) (Maguire, D.J.
et al., eds), In pp. 403–412, Longman Scientific and Technical
61 Evans, B. and Sabel, C.E. (2012) Open-source web-based geographical
information system for health exposure assessment. Int. J. Health.
Geogr. 11, 2
62 Fisher, R.P. and Myers, B.A. (2011) Free and simple GIS as
appropriate for health mapping in a low resource setting: a case
study in eastern Indonesia. Int. J. Health. Geogr. 10, 15
63 Lozano-Fuentes, S. et al. (2008) Use of Google Earth to strengthen
public health capacity and facilitate management of vector-borne
diseases in resource-poor environments. Bull. World Health Organ.
86, 718–725
64 Booman, M. et al. (2000) Using a geographical information system to
plan a malaria control programme in South Africa. Bull. World Health
Organ. 78, 1438–1444
65 Srivastava, A. et al. (2003) GIS based malaria information
management system for urban malaria scheme in India. Comput.
Methods Programs Biomed. 71, 63–75
66 Booman, M. et al. (2003) Enhancing malaria control using a
computerised management system in southern Africa. Malar. J. 2, 13
67 Martin, C. et al. (2002) The use of a GIS-based malaria information
system for malaria research and control in South Africa. Health Place
8, 227–236
68 Coleman, M. et al. (2006) Developing an evidence-based decision
support system for rational insecticide choice in the control of
African malaria vectors. J. Med. Entomol. 43, 663–668
69 Sithiprasasna, R. et al. (2004) The geographic information system as an
epidemiological tool in the surveillance of dengue virus-infected Aedes
mosquitoes. Southeast Asian J. Trop. Med. Public Health 35, 918–926
70 Teng, T.B. (2001) New initiatives in dengue control in Singapore.
Dengue Bull. 25, 1–6
71 Aileen, G.T. and Song, R.J. (2000) The use of GIS in ovitrap monitoring
for dengue control in Singapore. Dengue Bull. 24, 110–116
72 The Pacific Malaria Initiative Survey Group on behalf of the Ministries
of Health of Vanuatu, Solomon Islands (2010) Malaria on isolated
Melanesian islands prior to the initiation of malaria elimination
activities. Malar. J. 9,
Review
Trends
218
in Parasitology July 2012, Vol. 28, No. 7
