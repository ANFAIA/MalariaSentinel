...
uv run python -m agents.deepagents calibration --max-iterations 10

# Feature development cycle
uv run python -m agents.deepagents feature "name" "description"

# Research + improvement cycle
uv run python -m agents.deepagents research "topic" --cycles 3

# Dry-run (prints prompt without executing)
uv run python -m agents.deepagents calibration --dry-run
```
