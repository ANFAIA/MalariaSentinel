...
from agents.deepagents.tools.gitagent_tool import (
    gitagent_init,
    gitagent_start,
    gitagent_spawn,
...
class TestGitagentInit:
    @patch("agents.deepagents.tools.gitagent_tool.subprocess.run")
...
class TestGitagentSpawn:
    @patch("agents.deepagents.tools.gitagent_tool.subprocess.run")
    @patch("agents.deepagents.tools.gitagent_tool.Path")
