...
def test_builder_chain():
    from agents.deepagents.subagents.builder import build_resolved
    from agents.deepagents.plugins.edit import EditPlugin
    from agents.deepagents.plugins.readonly import ReadOnlyPlugin
    from agents.deepagents.subagents.base import SubagentSpec
    spec = SubagentSpec(
...
def test_mailbox_round_trip():
    from agents.deepagents.mailbox import mailbox_send, mailbox_check_inbox, mailbox_mark_resolved, set_session_dir
...
def test_scope_validator():
    from agents.deepagents.scope_validator import validate_proposal_scope
    from agents.deepagents.subagents.registry import Registry
    from agents.deepagents.subagents.base import SubagentSpec
    specs = {
