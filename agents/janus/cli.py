...
def run(
    ...
    from agents.janus.cycles.run_cycle import run_cycle
...
def calibration(
    ...
    _setup_module_flags(no_verify)
    from agents.janus.cycles.run_cycle import run_calibration_cycle
...
def feature(
    ...
    _setup_module_flags(no_verify)
    from agents.janus.cycles.run_cycle import run_feature_cycle
...
def research(
    ...
    _setup_module_flags(no_verify)
    from agents.janus.cycles.run_cycle import run_research_cycle
...
def onboard(
    ...
    from agents.janus.onboarding import run_onboarding
...
def improve(
    ...
    if not goal:
        goal = typer.prompt("What is your goal?")
    _setup_module_flags(no_verify)
    from agents.janus.improvement import run_improvement
...
def status():
    ...
    from agents.janus.onboarding import _show_status
...
def agents_list():
    ...
    from agents.janus.onboarding import _list_components
