...
class TestRunCommand:
    @patch("agents.janus.cycles.run_cycle.run_cycle")
...
class TestBackwardsCompatDeprecated:
    ...
    @patch("agents.janus.cycles.run_cycle.run_calibration_cycle")
