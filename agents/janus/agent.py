...
from agents.janus.tools import (
    opencode_search,
    gitagent_init,
    gitagent_start,
    gitagent_spawn,
...
from agents.janus.tools.abm_tools import (
    register_worktree,
    unregister_worktree,
    set_current_agent,
    clear_current_agent,
...
from agents.janus.observability import ObservabilityMiddleware
...
def _import_abm_run():
    ...
    from agents.janus.tools.abm_tools import abm_run
    return abm_run


def _import_abm_test():
    """Lazy import of abm_test tool."""
    from agents.janus.tools.abm_tools import abm_test
    return abm_test


def _import_abm_score():
    """Lazy import of abm_score tool."""
    from agents.janus.tools.abm_tools import abm_score
    return abm_score
